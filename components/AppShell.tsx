  ...
  return (
    <div className="flex h-screen overflow-hidden" style={{ background: 'var(--editor-bg)' }}>
      ...
      <div className="flex flex-col flex-1 min-w-0 overflow-hidden">
        {/* Top action bar */}
        <div className="flex items-center justify-end gap-2 px-4 py-2 border-b border-[#E5E0D8]" style={{ background: 'var(--editor-bg)' }}>
          {activeNote && (
            <button
          ...
          {activeNote ? (
            ...
            <div className="flex h-full items-center justify-center">
              <div className="text-center">
                <p className="text-[#C4BFB6] text-sm mb-3">No note selected</p>
                <button
        ...
        <div className="flex items-center justify-end px-4 py-1 gap-1 border-t border-[#E5E0D8]" style={{ background: 'var(--editor-bg)' }}>
